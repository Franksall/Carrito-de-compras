...
if (!$datosUsuario) {
    ...
    // Incluye el HTML y CSS para mostrar los datos del usuario y el formulario de edición
    ?>
    <!DOCTYPE html>
    <html lang="en">
            ...
            <div class="sidebar">
                ...
                <form method="post" action="actualizar_datos.php">
                    <div class="profile-info">
                        ...
                        <input type="text" name="telefono" value="<?php echo $datosUsuario['telefono']; ?>">
                    </div>
                    <div class="profile-info">
                        <H1 class="key">Email : </H1>
                        <input type="text" name="email" value="<?php echo $datosUsuario['email']; ?>">
                    </div>
                    <div class="profile-info">
                        <H1 class="key">DIRECCION : </H1>
                        <input type="text" name="direccion" value="<?php echo $datosUsuario['direccion']; ?>">
                    </div>
                    <div class="profile-info">
